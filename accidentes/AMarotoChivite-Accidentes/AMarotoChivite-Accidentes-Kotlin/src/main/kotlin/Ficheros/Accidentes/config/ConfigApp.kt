package Ficheros.Accidentes.config
...
object ConfigApp {
    ...
    private val LOCAL_PATH =
        "${System.getProperty("user.dir")}${File.separator}src${File.separator}main${File.separator}kotlin${File.separator}Ficheros${File.separator}Accidentes${File.separator}"
